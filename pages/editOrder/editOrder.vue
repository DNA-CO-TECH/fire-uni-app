			...
			<form @submit="formSubmit">
				<view class="form-item">
					<view class="w-full frc-start gap-8">
						<view>
							<image class="avatar"
								src="https://dnamini-1316443200.cos.ap-shanghai.myqcloud.com/yanstatic/manage/fire.svg" />
						</view>
				...
				<view class="form-item">
					...
					<picker @change="handlePeopleChange" class="time-slot-picker" mode="selector" name="timeInfo"
						:range="range" range-key="value">
						{{ formData.people }}
					</picker>
				</view>
