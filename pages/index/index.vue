<template>
	<view class="root">
		<view class="home-content" @click="handleClick">
			...
			<image class="logo" :fade-show="true" mode="widthFix"
				src="https://dnamini-1316443200.cos.ap-shanghai.myqcloud.com/yanstatic/home/yan_red.png" />
			<view :class="`${animate ? 'book text-animation' : 'hidden'}`">
				<view class="button-wrap">
					<view class="alipuhui-thin button" style="width:18px;z-index: 1;">预订</view>
					<image class="image" :fade-show="true" mode="widthFix"
						src="https://dnamini-1316443200.cos.ap-shanghai.myqcloud.com/yanstatic/home/arrow-down.svg" />
				</view>
			</view>
		</view>
	</view>
