<template>
	<view class="tab-box flex-1 text-right">
		<view @click="open">
			<image src="https://dnamini-1316443200.cos.ap-shanghai.myqcloud.com/yanstatic/book/arrow-up-right.png"
				class="arrow-tr-icon" />
			<text>分享给朋友</text>
		</view>
			...
			open() {
				const list = [{
					...
					childs: [{
						...
						width: 58, //宽度(rpx)
						height: 64, //高度(rpx)
						x: 250, //x轴位置(离左边的距离rpx)
						y: 60, //y轴位置(离上边的距离rpx)
						radius: 0, //圆角(rpx)
						lineWidth: 0, //边框宽度(rpx)
						lineColor: 'transparent', //边框颜色
						path: 'https://dnamini-1316443200.cos.ap-shanghai.myqcloud.com/yanstatic/home/yan_red.png', //图片地址(type为image时必填)
					}, {
						type: 'line', //绘制类型(color:背景色;image:图片;text:文字;line:线条),
						width: 4, //线条宽度(rpx)
						color: '#F06627', //线条颜色
						startX: 250, //起点x轴位置(离左边的距离rpx)
						startY: 180, //起点y轴位置(离上边的距离rpx)
						endX: 310, //终点x轴位置(离左边的距离rpx)
						endY: 180, //终点y轴位置(离上边的距离rpx)
						lineType: 'solid', //线条类型(solid:实线;dash:虚线)
					}, {
						type: 'text', //绘制类型(color:背景色;image:图片;text:文字;line:线条),
						width: 200, //文本宽度(rpx)
						height: 56, //文本高度(rpx)
						x: 225, //x轴位置(离左边的距离rpx)
						y: 238, //y轴位置(离上边的距离rpx)
						color: 'rgb(210,210,210)', //文本颜色
						fontSize: 28, //文字大小(rpx)
						lineHeight: 56, //文字行高(rpx)
						bold: true, //文字是否加粗
						...
						width: 400, //文本宽度(rpx)
						height: 56, //文本高度(rpx)
						x: 150, //x轴位置(离左边的距离rpx)
						y: 294, //y轴位置(离上边的距离rpx)
						color: 'rgba(196,198,202,0.8)', //文本颜色
						fontSize: 28, //文字大小(rpx)
						lineHeight: 44, //文字行高(rpx)
						bold: false, //文字是否加粗
						...
						width: 400, //文本宽度(rpx)
						height: 56, //文本高度(rpx)
						x: 230, //x轴位置(离左边的距离rpx)
						y: 334, //y轴位置(离上边的距离rpx)
						color: 'rgba(196,198,202,0.8)', //文本颜色
						fontSize: 28, //文字大小(rpx)
						lineHeight: 44, //文字行高(rpx)
						bold: false, //文字是否加粗
