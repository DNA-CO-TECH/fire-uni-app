<template>
	<view class="root flex flex-col">
		...
		<view class="book-container fcc-start" :style="{ backgroundColor: isEdit ? '#FFFFFF' : '#131415' }">
					...
					<view class="left">
						...
						<view class="table1-wrap">
							<view class="flex seat-row">
								<view v-for="seatIndex in [1, 2]" :key="seatIndex"
									@click="toggleBookSeats(0, seatIndex)" :class="{
										'seat': true,
										'seat-top': true,
							...
							<view class="flex seat-row">
								<view v-for="seatIndex in [3, 4]" :key="seatIndex"
									@click="toggleBookSeats(0, seatIndex)" :class="{
										'seat': true,
										'seat-bottom': true,
										'select-booked': myBookSeatsIds.includes(seatIndex),
						...
						<view class="table2-wrap">
							<view class="fcc-between gap-12">
								<view v-for="seatIndex in [5, 6, 7]" :key="seatIndex"
									@click="toggleBookSeats(1, seatIndex)" :class="{
										'seat': true,
										'seat-left': true,
										'select-booked': myBookSeatsIds.includes(seatIndex),
							...
							<view class="fcc-center gap-12">
								<view v-for="seatIndex in [8, 9, 10]" :key="seatIndex"
									@click="toggleBookSeats(1, seatIndex)" :class="{
										'seat': true,
										'seat-right': true,
										'select-booked': myBookSeatsIds.includes(seatIndex),
						...
						<view class="table3-wrap">
							<view class="flex seat-row">
								<view v-for="seatIndex in [11, 12]" :key="seatIndex"
									@click="toggleBookSeats(2, seatIndex)" :class="{
										'seat': true,
										'seat-top': true,
										'select-booked': myBookSeatsIds.includes(seatIndex),
							...
							<view class="flex seat-row">
								<view v-for="seatIndex in [13, 14]" :key="seatIndex"
									@click="toggleBookSeats(2, seatIndex)" :class="{
										'seat': true,
										'seat-bottom': true,
										'select-booked': myBookSeatsIds.includes(seatIndex),
					...
					<view class="right">
						...
						<view class="bar-wrap">
							<view class="fcc-between" :style="{ padding: '20px 0px' }">
								<view @click="toggleBookSeats(tableIndex)"
									v-for="tableIndex in [3, 4, 5, 6, 7, 8, 9, 10]" :key="tableIndex" :class="{
										'seat': true,
										'seat-left': true,
			...
			<view class="frc-center gap-20" style="width: calc(100% - 24px); margin:'0px 12px';height: 172rpx"
				v-if="isEdit">
